...
export class Snowman extends Character {
    ...
    constructor(canvas, image, data, xPercentage, yPercentage, name, minPosition){
        ...
        //Initial Position of Snowman
        this.x = xPercentage * GameEnv.innerWidth;

        //Access in which a Snowman can travel    
    ...
    update() {
        ...
        //Random Event 2: Time Stop All Snowmans
        if (GameControl.randomEventId === 2 && GameControl.randomEventState === 1) {
            this.speed = 0;
            if (this.name === "snowmanSpecial") {
                GameControl.endRandomEvent();
            };
        };

        //Random Event 3: Kill a Random Snowman
        //Whichever Snowman recieves this message first will die, then end the event so the other Snowmans don't die
        ...
        switch(GameEnv.difficulty) {
         ...
         //Chance for Snowman to turn Gold
    ...
    collisionAction() {
        ...
        if (this.collisionData.touchPoints.other.id === "player") {
            // Collision: Top of Snowman with Bottom of Player
        ...
        if (this.collisionData.touchPoints.other.id === "snowman") {
